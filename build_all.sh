...
echo "=========================================="
echo ""
echo "✓ Build Complete - Using Python 3.6"
echo ""
echo "What you can do now:"
echo "  1. Run visual game: ./target/release/cartpole"
echo "  2. Test Python: python3.6 -c 'import cartpole; print(\"Success!\")'"
echo "  3. Run tests: python3.6 test_setup.py"
echo "  4. Train AI: python3.6 train_ai.py"
echo ""
echo "Note: Using Python 3.6 (stock JetPack 4.6)"
echo ""
...
echo "  export PYO3_PYTHON=\$(which python3.6)"
